...
export const tabulaMeta: Project = {
  title: "Tabula Notlar",
  description:
...
export const blogv2Meta: Project = {
...
export const blogv1Meta: Project = {
...
export const portfolioMeta: Project = {
  title: "Portfolyo",
  description:
