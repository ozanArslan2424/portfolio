...
import { EnIcon, TrIcon } from "./icons/lang";
      ...
      <div className="card space-y-4">
        <header className="grid gap-4 md:grid-cols-[30%_70%] md:gap-0">
          ...
          <div className="flex w-full flex-col justify-between gap-4 px-4">
            ...
            <article className="prose hyphens-auto text-wrap break-words text-sm dark:prose-invert sm:text-base md:block lg:hidden">
        ...
        <article className="prose hidden hyphens-auto text-wrap break-words text-sm dark:prose-invert sm:text-base lg:block">
          <p>{about.description}</p>
        </article>
      </div>
